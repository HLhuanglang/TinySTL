...
模块名		: 基本算法
文件名		: algobase.h
相关文件		: type_traits.h、algorithm.h
文件实现功能	: 提供max、min、swap、copy、fill等算法
作者			: 派大星Pstar
版本			: 1.0
---------------------------------------------------------------------
多线程安全性 : <是/否>[，说明]
...
template<class _Ty,
	class _Pr>
	const _Ty& max(IN const _Ty& _Left, IN const _Ty& _Right, FUNC _Pr _Pred)
{	//由_Pred决定“大小比较”标准
...
template<class _Ty,
	class _Pr>
	const _Ty& min(IN const _Ty& _Left, IN const _Ty& _Right, FUNC _Pr _Pred)
{	//由_Pred决定“大小比较”标准
...
template<class _FwdIt1,
	...
	void iter_swap(IN _FwdIt1 _Left, IN _FwdIt2 _Right)
{	
	swap(*_Left, *_Right);
}
...
template<class _InIt1,
	class _InIt2> inline
	bool equal(IN _InIt1 _First1, IN _InIt1 _Last1, IN _InIt2 _First2)
{
